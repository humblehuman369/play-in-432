          ...
          <>
            ...
            <section className="player-card">
              ...
              <FrequencyStrip
                ...
                onSelect={player.applyFrequencyAnchor}
                ...
                <div className="pitch-inputs">
                  ...
                  <label className="pitch-field">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        player.setTargetA(Number(e.target.value))
                      }
                    />
                    <span className="unit">Hz</span>
                  </label>
              ...
              <div className="player-extras">
                ...
                <button
                  ...
                  onClick={() => void player.downloadRetuned()}
                  title={BRAND.downloadHqTitle}
                >
                  {player.exporting ? (
                    <>
                      <Loader2 size={14} className="spin" />
